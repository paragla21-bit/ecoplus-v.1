...
const ICTProTerminal = () => {
  ...
  // Cryptocurrencies
  { symbol: 'BTC', name: 'Bitcoin', sector: 'L1', volatility: 'Medium', basePrice: 87800 },
  { symbol: 'ETH', name: 'Ethereum', sector: 'L1', volatility: 'Medium-High', basePrice: 2940 },
  { symbol: 'SOL', name: 'Solana', sector: 'L1', volatility: 'High', basePrice: 122 },
  { symbol: 'BNB', name: 'Binance Coin', sector: 'Exchange', volatility: 'Medium', basePrice: 836 },
  { symbol: 'XRP', name: 'Ripple', sector: 'Payments', volatility: 'High', basePrice: 1.88 },
  { symbol: 'DOGE', name: 'Dogecoin', sector: 'Meme', volatility: 'High', basePrice: 0.28 }, // approx
  { symbol: 'ADA', name: 'Cardano', sector: 'L1', volatility: 'Medium-High', basePrice: 0.85 },
  { symbol: 'TRX', name: 'Tron', sector: 'L1', volatility: 'Medium', basePrice: 0.22 },
  { symbol: 'AVAX', name: 'Avalanche', sector: 'L1', volatility: 'High', basePrice: 45 },
  { symbol: 'SHIB', name: 'Shiba Inu', sector: 'Meme', volatility: 'High', basePrice: 0.000022 },
  { symbol: 'TON', name: 'Toncoin', sector: 'L1', volatility: 'High', basePrice: 6.5 },
  { symbol: 'LINK', name: 'Chainlink', sector: 'Oracle', volatility: 'Medium-High', basePrice: 22 },
  { symbol: 'DOT', name: 'Polkadot', sector: 'L1', volatility: 'Medium-High', basePrice: 8.5 },
  { symbol: 'NEAR', name: 'Near Protocol', sector: 'L1', volatility: 'High', basePrice: 7.2 },
  { symbol: 'MATIC', name: 'Polygon', sector: 'L2', volatility: 'High', basePrice: 0.95 },
  { symbol: 'PEPE', name: 'Pepe', sector: 'Meme', volatility: 'Extreme', basePrice: 0.000012 },
  { symbol: 'LTC', name: 'Litecoin', sector: 'Payments', volatility: 'Medium', basePrice: 95 },
  { symbol: 'BCH', name: 'Bitcoin Cash', sector: 'Payments', volatility: 'High', basePrice: 480 },
  { symbol: 'UNI', name: 'Uniswap', sector: 'DEX', volatility: 'High', basePrice: 12 },
  { symbol: 'ICP', name: 'Internet Computer', sector: 'L1', volatility: 'High', basePrice: 14 },
  { symbol: 'APT', name: 'Aptos', sector: 'L1', volatility: 'High', basePrice: 11 },
  { symbol: 'KAS', name: 'Kaspa', sector: 'L1', volatility: 'High', basePrice: 0.18 },
  { symbol: 'RENDER', name: 'Render', sector: 'AI', volatility: 'High', basePrice: 9.5 },
  { symbol: 'FET', name: 'Artificial Superintelligence', sector: 'AI', volatility: 'High', basePrice: 2.1 },
  { symbol: 'SUI', name: 'Sui', sector: 'L1', volatility: 'High', basePrice: 2.8 },
  { symbol: 'ARB', name: 'Arbitrum', sector: 'L2', volatility: 'High', basePrice: 1.2 },
  { symbol: 'TIA', name: 'Celestia', sector: 'Modular', volatility: 'High', basePrice: 8.5 },
  { symbol: 'OP', name: 'Optimism', sector: 'L2', volatility: 'High', basePrice: 3.2 },
  { symbol: 'WIF', name: 'dogwifhat', sector: 'Meme', volatility: 'Extreme', basePrice: 2.4 },
  { symbol: 'STX', name: 'Stacks', sector: 'L2', volatility: 'High', basePrice: 2.8 },
  { symbol: 'IMX', name: 'Immutable', sector: 'Gaming', volatility: 'High', basePrice: 2.1 },
  { symbol: 'FIL', name: 'Filecoin', sector: 'Storage', volatility: 'High', basePrice: 7.5 },
  { symbol: 'OKB', name: 'OKB', sector: 'Exchange', volatility: 'Medium', basePrice: 65 },
  { symbol: 'VET', name: 'VeChain', sector: 'L1', volatility: 'High', basePrice: 0.045 },
  { symbol: 'LDO', name: 'Lido DAO', sector: 'Liquid Staking', volatility: 'High', basePrice: 2.9 },
  { symbol: 'INJ', name: 'Injective', sector: 'L1', volatility: 'High', basePrice: 28 },
  { symbol: 'HBAR', name: 'Hedera', sector: 'L1', volatility: 'High', basePrice: 0.18 },
  { symbol: 'RUNE', name: 'THORChain', sector: 'DeFi', volatility: 'High', basePrice: 7.8 },
  { symbol: 'GRT', name: 'The Graph', sector: 'Web3', volatility: 'High', basePrice: 0.28 },
  { symbol: 'THETA', name: 'Theta Network', sector: 'Video', volatility: 'High', basePrice: 2.5 },
  { symbol: 'BONK', name: 'Bonk', sector: 'Meme', volatility: 'Extreme', basePrice: 0.000035 },
  { symbol: 'FLOKI', name: 'Floki', sector: 'Meme', volatility: 'Extreme', basePrice: 0.00028 },
  { symbol: 'MKR', name: 'Maker', sector: 'DeFi', volatility: 'Medium-High', basePrice: 2800 },
  { symbol: 'SEI', name: 'Sei', sector: 'L1', volatility: 'High', basePrice: 0.65 },
  { symbol: 'STRK', name: 'Starknet', sector: 'L2', volatility: 'High', basePrice: 1.1 },
  { symbol: 'AAVE', name: 'Aave', sector: 'DeFi', volatility: 'High', basePrice: 180 },
  { symbol: 'ALGO', name: 'Algorand', sector: 'L1', volatility: 'High', basePrice: 0.28 },
  { symbol: 'FLOW', name: 'Flow', sector: 'L1', volatility: 'High', basePrice: 1.1 },
  { symbol: 'EGLD', name: 'MultiversX', sector: 'L1', volatility: 'High', basePrice: 48 },
  { symbol: 'QNT', name: 'Quant', sector: 'Interoperability', volatility: 'Medium', basePrice: 120 },
  { symbol: 'JUP', name: 'Jupiter', sector: 'DEX', volatility: 'High', basePrice: 1.5 },
  { symbol: 'BEAM', name: 'Beam', sector: 'Gaming', volatility: 'High', basePrice: 0.032 },
  { symbol: 'PYTH', name: 'Pyth Network', sector: 'Oracle', volatility: 'High', basePrice: 0.55 },
  { symbol: 'ORDI', name: 'ORDI', sector: 'BRC-20', volatility: 'Extreme', basePrice: 65 },
  { symbol: 'SATS', name: '1000SATS', sector: 'BRC-20', volatility: 'Extreme', basePrice: 0.00045 },
  { symbol: 'DYDX', name: 'dYdX', sector: 'DEX', volatility: 'High', basePrice: 2.8 },
  { symbol: 'GALA', name: 'Gala Games', sector: 'Gaming', volatility: 'High', basePrice: 0.045 },
  { symbol: 'EOS', name: 'EOS', sector: 'L1', volatility: 'Medium', basePrice: 1.1 },
  { symbol: 'NEO', name: 'NEO', sector: 'L1', volatility: 'High', basePrice: 18 },
  { symbol: 'IOTA', name: 'IOTA', sector: 'IOT', volatility: 'High', basePrice: 0.35 },
  { symbol: 'JASMY', name: 'JasmyCoin', sector: 'IoT', volatility: 'Extreme', basePrice: 0.038 },
  { symbol: 'W', name: 'Wormhole', sector: 'Bridge', volatility: 'High', basePrice: 0.65 },
  { symbol: 'ENA', name: 'Ethena', sector: 'Stablecoin', volatility: 'High', basePrice: 0.95 },
  { symbol: 'BOME', name: 'Book of Meme', sector: 'Meme', volatility: 'Extreme', basePrice: 0.012 },
  { symbol: 'PENDLE', name: 'Pendle', sector: 'DeFi', volatility: 'High', basePrice: 5.5 },
  { symbol: 'AR', name: 'Arweave', sector: 'Storage', volatility: 'High', basePrice: 32 },
  { symbol: 'AKT', name: 'Akash Network', sector: 'AI/Cloud', volatility: 'High', basePrice: 5.2 },
  { symbol: 'AXS', name: 'Axie Infinity', sector: 'Gaming', volatility: 'High', basePrice: 9.5 },
  { symbol: 'SAND', name: 'The Sandbox', sector: 'Metaverse', volatility: 'High', basePrice: 0.65 },
  { symbol: 'MANA', name: 'Decentraland', sector: 'Metaverse', volatility: 'High', basePrice: 0.68 },
  { symbol: 'CHZ', name: 'Chiliz', sector: 'Fan Token', volatility: 'High', basePrice: 0.14 },
  { symbol: 'MINA', name: 'Mina Protocol', sector: 'L1', volatility: 'High', basePrice: 1.1 },
  { symbol: 'KAVA', name: 'Kava', sector: 'DeFi', volatility: 'High', basePrice: 0.75 },
  { symbol: 'CRV', name: 'Curve DAO', sector: 'DeFi', volatility: 'High', basePrice: 0.65 },
  { symbol: 'GMX', name: 'GMX', sector: 'DEX', volatility: 'High', basePrice: 48 },
  { symbol: 'SNX', name: 'Synthetix', sector: 'DeFi', volatility: 'High', basePrice: 3.2 },
  { symbol: 'LUNC', name: 'Terra Classic', sector: 'L1', volatility: 'Extreme', basePrice: 0.00018 },
  { symbol: 'FTM', name: 'Fantom', sector: 'L1', volatility: 'High', basePrice: 0.95 },
  { symbol: 'RON', name: 'Ronin', sector: 'Gaming', volatility: 'High', basePrice: 3.1 },
  { symbol: 'CKB', name: 'Nervos Network', sector: 'L1', volatility: 'High', basePrice: 0.022 },

  // Forex Pairs (rate in USD terms)
  { symbol: 'EUR/USD', name: 'Euro / US Dollar', category: 'Major', volatility: 'Medium', basePrice: 1.17 },
  { symbol: 'GBP/USD', name: 'British Pound / US Dollar', category: 'Major', volatility: 'Medium-High', basePrice: 1.36 },
  { symbol: 'USD/JPY', name: 'US Dollar / Japanese Yen', category: 'Major', volatility: 'High', basePrice: 155 },
  { symbol: 'USD/CHF', name: 'US Dollar / Swiss Franc', category: 'Major', volatility: 'Medium', basePrice: 0.88 }, // approx inverse
  { symbol: 'AUD/USD', name: 'Australian Dollar / US Dollar', category: 'Major', volatility: 'Medium-High', basePrice: 0.66 },
  { symbol: 'USD/CAD', name: 'US Dollar / Canadian Dollar', category: 'Major', volatility: 'Medium', basePrice: 1.40 },
  { symbol: 'NZD/USD', name: 'New Zealand Dollar / US Dollar', category: 'Major', volatility: 'Medium-High', basePrice: 0.62 },
  { symbol: 'GBP/JPY', name: 'British Pound / Japanese Yen', category: 'Minor', volatility: 'High', basePrice: 210 },
  { symbol: 'EUR/JPY', name: 'Euro / Japanese Yen', category: 'Minor', volatility: 'High', basePrice: 181 },
  { symbol: 'EUR/GBP', name: 'Euro / British Pound', category: 'Minor', volatility: 'Low-Medium', basePrice: 0.86 },
  { symbol: 'AUD/JPY', name: 'Australian Dollar / Japanese Yen', category: 'Minor', volatility: 'High', basePrice: 102 },
  { symbol: 'GBP/AUD', name: 'British Pound / Australian Dollar', category: 'Minor', volatility: 'High', basePrice: 2.06 },
  { symbol: 'EUR/AUD', name: 'Euro / Australian Dollar', category: 'Minor', volatility: 'High', basePrice: 1.77 },
  { symbol: 'GBP/CAD', name: 'British Pound / Canadian Dollar', category: 'Minor', volatility: 'Medium-High', basePrice: 1.90 },
  { symbol: 'CHF/JPY', name: 'Swiss Franc / Japanese Yen', category: 'Minor', volatility: 'High', basePrice: 176 },
  { symbol: 'NZD/JPY', name: 'New Zealand Dollar / Japanese Yen', category: 'Minor', volatility: 'High', basePrice: 96 },
  { symbol: 'EUR/CAD', name: 'Euro / Canadian Dollar', category: 'Minor', volatility: 'Medium', basePrice: 1.64 },
  { symbol: 'AUD/CAD', name: 'Australian Dollar / Canadian Dollar', category: 'Minor', volatility: 'Medium', basePrice: 0.92 },
  { symbol: 'CAD/JPY', name: 'Canadian Dollar / Japanese Yen', category: 'Minor', volatility: 'High', basePrice: 110 },
  { symbol: 'EUR/CHF', name: 'Euro / Swiss Franc', category: 'Minor', volatility: 'Low', basePrice: 1.03 },
  { symbol: 'USD/ZAR', name: 'US Dollar / South African Rand', category: 'Exotic', volatility: 'Extreme', basePrice: 18.5 },
  { symbol: 'USD/TRY', name: 'US Dollar / Turkish Lira', category: 'Exotic', volatility: 'Extreme', basePrice: 35 },
  { symbol: 'USD/MXN', name: 'US Dollar / Mexican Peso', category: 'Exotic', volatility: 'High', basePrice: 20 },
  { symbol: 'USD/NOK', name: 'US Dollar / Norwegian Krone', category: 'Exotic', volatility: 'High', basePrice: 10.5 },
  { symbol: 'USD/SEK', name: 'US Dollar / Swedish Krona', category: 'Exotic', volatility: 'High', basePrice: 10.2 },
  { symbol: 'USD/DKK', name: 'US Dollar / Danish Krone', category: 'Exotic', volatility: 'Medium', basePrice: 7.0 },
  { symbol: 'USD/SGD', name: 'US Dollar / Singapore Dollar', category: 'Exotic', volatility: 'Low-Medium', basePrice: 1.33 },
  { symbol: 'USD/HKD', name: 'US Dollar / Hong Kong Dollar', category: 'Exotic', volatility: 'Low', basePrice: 7.8 },
  { symbol: 'USD/INR', name: 'US Dollar / Indian Rupee', category: 'Exotic', volatility: 'Medium', basePrice: 85.5 },
  { symbol: 'USD/CNH', name: 'US Dollar / Chinese Yuan (Offshore)', category: 'Exotic', volatility: 'Medium', basePrice: 7.2 },
  { symbol: 'EUR/TRY', name: 'Euro / Turkish Lira', category: 'Exotic', volatility: 'Extreme', basePrice: 41 },
  { symbol: 'GBP/ZAR', name: 'British Pound / South African Rand', category: 'Exotic', volatility: 'Extreme', basePrice: 25 },
  { symbol: 'AUD/SGD', name: 'Australian Dollar / Singapore Dollar', category: 'Exotic', volatility: 'Medium', basePrice: 0.88 },
  { symbol: 'USD/PLN', name: 'US Dollar / Polish Zloty', category: 'Exotic', volatility: 'High', basePrice: 4.0 },
  { symbol: 'USD/HUF', name: 'US Dollar / Hungarian Forint', category: 'Exotic', volatility: 'Extreme', basePrice: 380 },
  { symbol: 'USD/CZK', name: 'US Dollar / Czech Koruna', category: 'Exotic', volatility: 'High', basePrice: 23 },
  { symbol: 'USD/ILS', name: 'US Dollar / Israeli Shekel', category: 'Exotic', volatility: 'High', basePrice: 3.7 },
  { symbol: 'USD/THB', name: 'US Dollar / Thai Baht', category: 'Exotic', volatility: 'Medium', basePrice: 34 },
  { symbol: 'EUR/PLN', name: 'Euro / Polish Zloty', category: 'Exotic', volatility: 'High', basePrice: 4.3 },
  { symbol: 'USD/BRL', name: 'US Dollar / Brazilian Real', category: 'Exotic', volatility: 'High', basePrice: 5.8 }
];
